...
cc.Class({
    ...
    onLoad() {
        ...
        // 加载 SpriteFrame
        var self = this;
        console.log(G.userInfo.avatarUrl)
        //这个变量存储的是微信头像的url，但我加载不到组件上。。。
        //这里想把用户的微信头像加载到主页上，但是加载不上
        console.log(self.node.children[2].getComponent(cc.Sprite))
        // cc.loader.load({url:G.userInfo.avatarUrl, type: 'png'}, cc.SpriteFrame, function (err, data) {
